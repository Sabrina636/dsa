...
GT_MASKS_DIR = os.path.join(ROOT_DIR, "original_masks_CLA")
...
METHODS = {
    "Classic (Single)": CLASSIC_SINGLE_DIR,
    "Classic (DSA)": CLASSIC_DSA_DIR
}
...
def visualize_comparison(sample):
    ...
    save_path = os.path.join(SAVE_DIR, f"{case_id}_comparison_classic.png")
